...
class FixBot(GenericSaniBot):
    ...
    def _unpack_obj(self, input_context: Dict):
        ...
        additional_fields = {
            "exception_type": input_context[ct.execution.value][ct.traceback.value][
                ct.exception_type.value
            ],
            "exception_message": input_context[ct.execution.value][ct.traceback.value][
                ct.exception_message.value
            ],
            "full_traceback": input_context[ct.execution.value][ct.traceback.value][
                ct.full_traceback.value
            ],
            "error line": input_context[ct.execution.value][ct.traceback.value][
                ct.error_line.value
            ],
        }
...
class ImproveBot(GenericSaniBot):
    ...
    def __init__(self, context, *args, model_name=None, **kwargs) -> None:
        super().__init__(
            context, mode="improve", model_name=model_name, *args, **kwargs
        )
    ...
    def _unpack_obj(self, input_context: Dict):
        ...
        additional_fields = {
            ...
            "linter": input_context[ct.prompt.value][ct.suggestions.value][
                ct.linter.value
            ],
            "linter suggestions": input_context[ct.prompt.value][ct.suggestions.value][
                ct.lint_suggestions.value
            ],
        }
        prompt_data = {**base_fields, **additional_fields}
        return prompt_data
...
class TestBot(GenericSaniBot):
    ...
    def _unpack_obj(self, input_context: Dict):
        base_fields = super()._unpack_obj(input_context)
        del base_fields['output']
        additional_fields = {"language": input_context[ct.source.value][ct.language.value]}
        prompt_data = {**base_fields, **additional_fields}
        return prompt_data
...
class DocumentBot(GenericSaniBot):
    ...
    def __init__(self, context, *args, model_name=None, **kwargs) -> None:
        super().__init__(
            context, mode="document", model_name=model_name, *args, **kwargs
        )

    # def _unpack_obj(self, input_context: Dict):
    #     prompt_data = {
    #         "language": input_context[ct.source.value][ct.language.value],
    #         "intended action": input_context[ct.prompt.value][ct.suggestions.value][
    #             ct.subject.value
    #         ],
...
class AnalyzeBot(GenericSaniBot):
    ...
    def __init__(self, context, *args, model_name=None, **kwargs) -> None:
        super().__init__(
            context, mode="analyze", model_name=model_name, *args, **kwargs
        )
